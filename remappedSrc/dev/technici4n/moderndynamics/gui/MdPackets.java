...
public class MdPackets {
    public static final Identifier SET_ATTACHMENT_UPGRADES = MdId.of("set_attachment_upgrades");
    ...
    public static final UnsidedPacketHandler SET_ITEM_VARIANT_HANDLER = (player, buf) -> {
        ...
        return () -> {
            ...
            if (handler.syncId == syncId && handler instanceof ItemAttachedIoMenu attachmentMenu) {
    ...
    public static final Identifier SET_FLUID_VARIANT = MdId.of("set_fluid_variant");
    public static final UnsidedPacketHandler SET_FLUID_VARIANT_HANDLER = (player, buf) -> {
        ...
        return () -> {
            ScreenHandler handler = player.currentScreenHandler;
            if (handler.syncId == syncId && handler instanceof FluidAttachedIoMenu attachmentMenu) {
                attachmentMenu.setFilter(configIdx, variant, false);
            }
        };
    };
    ...
    public static final Identifier SET_FILTER_MODE = MdId.of("set_filter_mode");
    ...
    public static final Identifier SET_FILTER_DAMAGE = MdId.of("set_filter_damage");
    ...
    public static final Identifier SET_FILTER_NBT = MdId.of("set_filter_nbt");
    ...
    public static final Identifier SET_FILTER_MOD = MdId.of("set_filter_mod");
    ...
    public static final Identifier SET_FILTER_SIMILAR = MdId.of("set_filter_similar");
    ...
    public static final Identifier SET_ROUTING_MODE = MdId.of("set_routing_mode");
    ...
    public static final Identifier SET_OVERSENDING_MODE = MdId.of("set_oversending_mode");
    ...
    public static final Identifier SET_REDSTONE_MODE = MdId.of("set_redstone_mode");
    ...
    public static final Identifier SET_MAX_ITEMS_IN_INVENTORY = MdId.of("set_max_items_in_inventory");
    ...
    public static final Identifier SET_MAX_ITEMS_EXTRACTED = MdId.of("set_max_items_extracted");
    ...
    private static <T extends Enum<T>> void sendSetEnum(int syncId, Identifier packetId, T enumValue) {
        var buffer = new PacketByteBuf(Unpooled.buffer(64));
        buffer.writeInt(syncId);
        buffer.writeEnumConstant(enumValue);
        ClientPlayNetworking.send(packetId, buffer);
    }

    private static <T extends Enum<T>, M extends ScreenHandler> UnsidedPacketHandler createSetEnumHandler(Class<T> enumClass,
            Class<M> menuClass, EnumSetter<T, M> setter) {
        return (player, buf) -> {
            int syncId = buf.readInt();
            var enumValue = buf.readEnumConstant(enumClass);
            return () -> {
                ScreenHandler handler = player.currentScreenHandler;
    ...
    private static void sendSetInt(int syncId, Identifier packetId, int value) {
        var buffer = new PacketByteBuf(Unpooled.buffer(64));
        buffer.writeInt(syncId);
    ...
    private interface EnumSetter<T extends Enum<T>, M extends ScreenHandler> {
